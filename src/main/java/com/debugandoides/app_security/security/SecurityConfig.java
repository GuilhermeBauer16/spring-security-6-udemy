...
import com.debugandoides.app_security.services.CustomUserDetails;
...
public class SecurityConfig {
    ...
    @Bean
    AuthenticationProvider authenticationProvider(PasswordEncoder encoder, CustomUserDetails userDetails) {
